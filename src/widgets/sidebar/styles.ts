export const styles = {
  ...
  logoBadge: "w-8 h-8 rounded-lg gradient-accent flex items-center justify-center shrink-0",
  ...
  navLinkBase: "w-full flex items-center justify-center lg:justify-start gap-3 lg:px-3 py-2.5 rounded-xl text-sm font-medium transition-all",
  navLinkActive: "bg-accent-indigo/10 text-accent-cyan lg:border-l-2 lg:border-accent-indigo lg:rounded-l-none",
  navLinkInactive: "text-text-secondary hover:text-text-primary hover:bg-surface-hover",
  navLinkLabel: "hidden lg:block",

  profileLinkBase: "flex items-center justify-center lg:justify-start gap-3 p-2 lg:p-3 rounded-xl transition-all mt-1",
  profileLinkActive: "bg-accent-indigo/10 ring-1 ring-accent-indigo",
  profileLinkInactive: "bg-surface-hover hover:bg-border-base",
  profileAvatar: "w-8 h-8 rounded-full gradient-accent flex items-center justify-center text-white text-xs font-bold shrink-0",
  ...
  logoutButton: "w-full justify-center lg:justify-start gap-3 lg:px-3 py-2 rounded-xl text-text-muted hover:text-price-down hover:bg-price-down/10",
};
