export const styles = {
  ...
  item:
    "flex items-center justify-between gap-3 rounded-lg px-3 py-2 text-sm text-text-primary cursor-pointer outline-none select-none data-[highlighted]:bg-bg data-[state=checked]:text-accent-indigo",
};
